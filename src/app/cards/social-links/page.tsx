      ...
      <div className="bg-[#1f1f1f] p-8 rounded-lg flex flex-col items-center">
        ...
        <div className="flex flex-col w-full mt-4 ">
          {socialLinks.map((link, index) => (
            <div
              key={index}
              className="m-1.5 p-2 rounded-lg bg-[#333333] text-center font-semibold text-xs hover:bg-[#a6c93c] hover:text-[#1f1f1f] hover:cursor-pointer transition-all duration-200 text-white"
            >
              {link}
            </div>
          ))}
